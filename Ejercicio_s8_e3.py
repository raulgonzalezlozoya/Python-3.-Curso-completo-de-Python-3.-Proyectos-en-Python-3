...
# Crear una variable "numeros" con la lista de los números del uno al 10 (ambos incluidos)
...
# Si el numero introducido no está en la lista de números, mostrar el mensaje "No".
